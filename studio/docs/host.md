...
The following environment variables need to be configured in your hosting provider's dashboard. These are crucial for the application to connect to your database.

*   `DB_HOST`: Your database host.
*   `DB_PORT`: The port your database is listening on (e.g., `3306`).
...
*   `DB_SSL_REJECT_UNAUTHORIZED`: Set to `true` or `false` for SSL certificate validation.
